...
import { CrearUsuarioRequest, CrearUsuarioResultDto, Usuario } from '../models/usuario.model';
...
export class GestionUsuariosService {
  ...
  crear(dto: CrearUsuarioRequest): Observable<CrearUsuarioResultDto> {
    return this.http.post<CrearUsuarioResultDto>(this.base, dto);
  }

...
export class DialogoConfirmacionEnvioQrComponent {
  constructor(
    private dialogRef: MatDialogRef<DialogoConfirmacionEnvioQrComponent>,
    @Inject(MAT_DIALOG_DATA) public data: DatosConfirmacionEnvioQr
  ) {}
